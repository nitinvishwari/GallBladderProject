...
namespace SimpleVideoCutter
{
    public partial class MainForm : Form
    {
        ...
        private void EnqeueNewTask()
        {
            ...
            VideoCutterSettings.Instance.ShowTaskWindow = true;
        ...
        private void QualityToGUI(FFmpegTask Task)
        {
        ...
        private void StepToGUI(FFmpegTask Task)
        {
        ...
        private void VlcControl1_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            statusStrip.InvokeIfRequired(() =>
            {
                toolStripStatusLabelVolume.Text = $"{GlobalStrings.MainForm_Volume}: {rate}X";
            });

            ThreadPool.QueueUserWorkItem(_ =>
            {
                vlcControl1.MediaPlayer.SetRate(rate);
            });
        }
